...
describe('IotfManagedGateway', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should throw an error if instantiated without config', () => {
      expect(() => {
        let client = new ManagedGatewayClient();
    ...
    it('should throw an error if org is not a string', () => {
      expect(() => {
        let client = new ManagedGatewayClient({org: false});
    ...
    describe('Quickstart mode', () => {
      it('should throw an error if managed device attemps to run in quickstart mode', () => {
       expect(() => {
          let client = new ManagedGatewayClient({org:'quickstart', id:'123', 'type': '123'});
    ...
    describe('Registered mode', () => {
      ...
      it('should return an instance if org, id and type are specified', () => {
        let client;
        expect(() => {
          client = new ManagedGatewayClient({org:'regorg', id:'123', 'auth-token': '123', 'type': '123', 'auth-method': 'token'});
        }).not.to.throw();
        expect(client).to.be.instanceof(ManagedGatewayClient);
      });

      it('should run in registered mode if org is not set to "quickstart"', () => {
        let client = new ManagedGatewayClient({org: 'qs', type: 'mytype', id: '3215', 'auth-method': 'token', 'auth-token': 'abc'});
  ...
  describe('.connect()', () => {
    ...
    it('should connect to the correct broker', () => {
      ...
      let client = new ManagedGatewayClient({org:'regorg', id:'123', 'auth-token': '123', 'type': '123', 'auth-method': 'token'});
      client.connect();
  ...
  describe('.manage()', () => {
    it('should throw an error if client is not connected', () => {
      expect(() => {
        let client = new ManagedGatewayClient({org: 'regorg', type: 'mytype', id: '3215', 'auth-method': 'token', 'auth-token': 'abc'});
