...
export default class ApplicationClient extends BaseClient {
 ...
 // Acceptable operation id - deactivate-configuration 
  ...
  createRule(logicalInterfaceId, name, condition, description=undefined, notificationStrategy=ApplicationClient.RuleNotificationStrategy.EVERY_TIME()) {
    var body = {
      name,
      condition,
...
ApplicationClient.RuleNotificationStrategy = {
  EVERY_TIME: () => ({
      when: 'every-time'
  }),
  BECOMES_TRUE: () => ({
